...
public class Notification implements Serializable {
    ...
    public Notification(Integer notificationId, String message, boolean isRead, Date createdDate) {
        this.notificationId = notificationId;
    ...
    public String toString() {
        return "com.ttkp.pojo.Notification[ notificationId=" + notificationId + " ]";
    }
